...
class TulingWXBot(WXBot):
    ...
    def auto_switch(self, msg):
        ...
        if self.robot_switch:
            ...
            if msg_data[:1] == u"去":
                self.masterstatus = msg_data[msg_data.find(u"去")+1:] + u"ing";
                self.robot_switch = True
                self.send_msg_by_uid(u'[Mobot]' + u'机器人已启动！\n主人当前状态：'+ self.masterstatus, msg['to_user_id'])
            else:
                self.send_msg_by_uid(u'开启错误，开启格式：“去**”,如去洗澡', msg['to_user_id'])
    ...
    def handle_msg_all(self, msg):
        ...
        if msg['msg_type_id'] == 1 and msg['content']['type'] == 0:  # reply to self
            ...
            tempmsg = u"鹏博在" + self.masterstatus +u",有事请留言。\n急事请电话联系：18629027590"
            self.send_msg_by_uid(tempmsg,msg['user']['id'])
